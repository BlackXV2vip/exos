...
# Package managers
npm i -g exos-agent-ai@latest        # or bun/pnpm/yarn
scoop install exos-agent             # Windows
choco install exos-agent             # Windows
brew install anomalyco/tap/exos-agent # macOS and Linux (recommended, always up to date)
brew install exos-agent              # macOS and Linux (official brew formula, updated less)
...
Exos Agent ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/exos-agent/releases) অথবা [exos-agent.ai/download](https://exos-agent.ai/download) থেকে ডাউনলোড করুন।
...
1. `$EXOS_AGENT_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.exos-agent/bin` - ডিফল্ট ফলব্যাক
...
Exos Agent এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://exos-agent.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Exos Agent কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://exos-agent.ai/docs)।

### অবদান (Contributing)

আপনি যদি Exos Agent এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Exos Agent এর উপর বিল্ডিং (Building on Exos Agent)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Exos Agent এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "exos-agent" ব্যবহার করেন, উদাহরণস্বরূপ "exos-agent-dashboard" বা "exos-agent-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Exos Agent দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/exos-agent) | [X.com](https://x.com/exos-agent)
