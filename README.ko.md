...
# 패키지 매니저
npm i -g exos-agent-ai@latest        # bun/pnpm/yarn 도 가능
...
Exos Agent 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://exos-agent.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

Exos Agent 설정에 대한 자세한 내용은 [**문서**](https://exos-agent.ai/docs) 를 참고하세요.

### 기여하기

Exos Agent 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### Exos Agent 기반으로 만들기

Exos Agent 와 관련된 프로젝트를 진행하면서 이름에 "exos-agent"(예: "exos-agent-dashboard" 또는 "exos-agent-mobile") 를 포함한다면, README 에 해당 프로젝트가 Exos Agent 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/exos-agent) | [X.com](https://x.com/exos-agent)
