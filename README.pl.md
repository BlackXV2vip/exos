...
# Menedżery pakietów
npm i -g exos-agent-ai@latest        # albo bun/pnpm/yarn
...
1. `$EXOS_AGENT_INSTALL_DIR` - Własny katalog instalacji
2. `$XDG_BIN_DIR` - Ścieżka zgodna ze specyfikacją XDG Base Directory
3. `$HOME/bin` - Standardowy katalog binarny użytkownika (jeśli istnieje lub można go utworzyć)
4. `$HOME/.exos-agent/bin` - Domyślny fallback
...
Exos Agent zawiera dwóch wbudowanych agentów, między którymi możesz przełączać się klawiszem `Tab`.
...
Dowiedz się więcej o [agents](https://exos-agent.ai/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji Exos Agent znajdziesz w [**dokumentacji**](https://exos-agent.ai/docs).

### Współtworzenie

Jeśli chcesz współtworzyć Exos Agent, przeczytaj [contributing docs](./CONTRIBUTING.md) przed wysłaniem pull requesta.

### Budowanie na Exos Agent

Jeśli pracujesz nad projektem związanym z Exos Agent i używasz "exos-agent" jako części nazwy (na przykład "exos-agent-dashboard" lub "exos-agent-mobile"), dodaj proszę notatkę do swojego README, aby wyjaśnić, że projekt nie jest tworzony przez zespół Exos Agent i nie jest z nami w żaden sposób powiązany.

---

**Dołącz do naszej społeczności** [Discord](https://discord.gg/exos-agent) | [X.com](https://x.com/exos-agent)
