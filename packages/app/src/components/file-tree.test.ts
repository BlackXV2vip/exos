...
beforeAll(async () => {
  ...
  mock.module("@exos-agent-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@exos-agent-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@exos-agent-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@exos-agent-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
