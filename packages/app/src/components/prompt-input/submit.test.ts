...
beforeAll(async () => {
  ...
  mock.module("@exos-agent-ai/sdk/v2/client", () => ({
    createExosAgentClient: (input: { directory: string }) => {
      createdClients.push(input.directory)
      return clientFor(input.directory)
    },
  }))

  mock.module("@exos-agent-ai/ui/toast", () => ({
    Toast: { Region: () => null },
    showToast: () => 0,
  }))

  mock.module("@exos-agent-ai/core/util/encode", () => ({
