...
import type { Config, ExosAgentClient, Project, Session } from "@exos-agent-ai/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@exos-agent-ai/session-ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as ExosAgentClient
