...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ExosAgentClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: ExosAgentClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ExosAgentClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => ExosAgentClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, ExosAgentClient>()
