...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "Exos Agent Documentation", href: "https://exos-agent.ai/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/exos-agent" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/BlackXV2vip/exos/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/BlackXV2vip/exos/issues/new?template=bug_report.yml",
      },
    ],
  },
]
