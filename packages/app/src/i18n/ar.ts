export const dict = {
  ...
  "dialog.provider.exos-agent.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.exos-agent.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.exosAgentGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "يمنحك Exos Agent Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "قم بزيارة ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Exos Agent.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في exos-agent.json",
  ...
  "dialog.server.description": "تبديل خادم Exos Agent الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingExosAgent": "جارٍ التحقق من Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "جارٍ التحقق من Exos Agent في {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "جارٍ تحديث Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "جارٍ تحديث Exos Agent في {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "حدّث Exos Agent في {{distro}}.",
  "wsl.onboarding.updateExosAgent": "تحديث Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent جاهز في {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent جاهز.",
  "wsl.onboarding.installExosAgentIn": "ثبّت Exos Agent في {{distro}}.",
  "wsl.onboarding.installExosAgent": "تثبيت Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Exos Agent من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Exos Agent التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Exos Agent.",
  ...
  "toast.update.description": "نسخة جديدة من Exos Agent ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Exos Agent",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (exos-agent.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Exos Agent لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Exos Agent نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Exos Agent داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Exos Agent",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Exos Agent على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Exos Agent يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Exos Agent.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Exos Agent",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Exos Agent.",
