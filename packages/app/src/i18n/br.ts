export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.exos-agent.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.exosAgentGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "Visite ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Exos Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurados em exos-agent.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Exos Agent este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingExosAgent": "Verificando o Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Verificando o Exos Agent em {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Atualizando o Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Atualizando o Exos Agent em {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Atualize o Exos Agent em {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Atualizar o Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "O Exos Agent está pronto em {{distro}}.",
  "wsl.onboarding.exosAgentReady": "O Exos Agent está pronto.",
  "wsl.onboarding.installExosAgentIn": "Instale o Exos Agent em {{distro}}.",
  "wsl.onboarding.installExosAgent": "Instalar o Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Exos Agent possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Exos Agent não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Exos Agent novamente.",
  ...
  "toast.update.description": "Uma nova versão do Exos Agent ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Exos Agent",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (exos-agent.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Exos Agent ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Exos Agent dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Exos Agent",
  ...
  "settings.general.row.appearance.description": "Personalize como o Exos Agent aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Exos Agent segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Exos Agent é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Exos Agent iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Exos Agent.",
