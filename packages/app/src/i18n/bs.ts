export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.exos-agent.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.exosAgentGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Exos Agent-u.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "Posjeti ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Exos Agent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Exos Agent-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u exos-agent.json",
  ...
  "dialog.server.description": "Promijeni na koji se Exos Agent server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingExosAgent": "Provjera Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Provjera Exos Agent u distribuciji {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Ažuriranje Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Ažuriranje Exos Agent u distribuciji {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Ažuriraj Exos Agent u distribuciji {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Ažuriraj Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent je spreman.",
  "wsl.onboarding.installExosAgentIn": "Instaliraj Exos Agent u distribuciji {{distro}}.",
  "wsl.onboarding.installExosAgent": "Instaliraj Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Exos Agent mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Exos Agent.",
  ...
  "toast.update.description": "Nova verzija Exos Agent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Exos Agent timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (exos-agent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Exos Agent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Exos Agent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Exos Agent-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Exos Agent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Exos Agent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Exos Agent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Exos Agent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Exos Agent-a.",
