export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.exos-agent.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.exosAgentGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.exosAgentZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.exosAgentZen.visit.prefix": "Besøg ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Exos Agent.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i exos-agent.json",
  ...
  "dialog.server.description": "Skift hvilken Exos Agent-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingExosAgent": "Tjekker Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Tjekker Exos Agent i {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Opdaterer Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Opdaterer Exos Agent i {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Opdater Exos Agent i {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Opdater Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Exos Agent kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Exos Agent igen.",
  ...
  "toast.update.description": "En ny version af Exos Agent ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Exos Agent-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (exos-agent.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Exos Agent understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Exos Agent-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Exos Agent",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Exos Agent ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Exos Agent følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Exos Agent er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Exos Agent starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Exos Agent.",
