...
export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.exos-agent.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.exosAgentGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Exos Agent zu nutzen.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.exosAgentZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.exosAgentZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Exos Agent zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Exos Agent zu nutzen.",
  ...
  "dialog.plugins.empty": "In exos-agent.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Exos Agent-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.exos-agent": "Exos Agent",
  ...
  "wsl.onboarding.checkingExosAgent": "Exos Agent wird geprüft...",
  "wsl.onboarding.checkingExosAgentIn": "Exos Agent in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingExosAgent": "Exos Agent wird aktualisiert...",
  "wsl.onboarding.updatingExosAgentIn": "Exos Agent in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateExosAgentIn": "Aktualisieren Sie Exos Agent in {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Exos Agent aktualisieren",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent ist in {{distro}} bereit.",
  "wsl.onboarding.exosAgentReady": "Exos Agent ist bereit.",
  "wsl.onboarding.installExosAgentIn": "Installieren Sie Exos Agent in {{distro}}.",
  "wsl.onboarding.installExosAgent": "Exos Agent installieren",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Exos Agent einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Exos Agent erneut.",
  ...
  "toast.update.description": "Eine neue Version von Exos Agent ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Exos Agent-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (exos-agent.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Exos Agent unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Exos Agent Desktop",
  ...
  "settings.desktop.wsl.description": "Exos Agent-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Exos Agent ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Exos Agent auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Exos Agent dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Exos Agent anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Exos Agent automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Exos Agent.",
