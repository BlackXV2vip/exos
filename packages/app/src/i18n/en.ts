export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.exos-agent.tagline": "Reliable optimized models",
  "dialog.provider.exosAgentGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Exos Agent.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.exosAgentZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.exosAgentZen.visit.prefix": "Visit ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Exos Agent.",
  ...
  "dialog.plugins.empty": "Plugins configured in exos-agent.json",
  ...
  "dialog.server.description": "Switch which Exos Agent server this app connects to.",
  ...
  "wsl.onboarding.checkingExosAgent": "Checking Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Checking Exos Agent in {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Updating Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Updating Exos Agent in {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Update Exos Agent in {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Update Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent is ready in {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent is ready.",
  "wsl.onboarding.installExosAgentIn": "Install Exos Agent in {{distro}}.",
  "wsl.onboarding.installExosAgent": "Install Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Exos Agent can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Exos Agent.",
  ...
  "toast.update.description": "A new version of Exos Agent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Exos Agent team",
  ...
  "error.chain.checkConfig": "Check your config (exos-agent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Exos Agent does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Exos Agent server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Exos Agent",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Exos Agent looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Exos Agent follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Exos Agent is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Exos Agent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Exos Agent.",
