export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.exos-agent.tagline": "Modelos optimizados y fiables",
  "dialog.provider.exosAgentGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.exosAgentZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.exosAgentZen.visit.prefix": "Visita ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Exos Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurados en exos-agent.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Exos Agent se conecta esta app.",
  ...
  "wsl.onboarding.checkingExosAgent": "Comprobando Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Comprobando Exos Agent en {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Actualizando Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Actualizando Exos Agent en {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Actualiza Exos Agent en {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Actualizar Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent está listo en {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent está listo.",
  "wsl.onboarding.installExosAgentIn": "Instala Exos Agent en {{distro}}.",
  "wsl.onboarding.installExosAgent": "Instalar Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Exos Agent pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Exos Agent.",
  ...
  "toast.update.description": "Una nueva versión de Exos Agent ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Exos Agent",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (exos-agent.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Exos Agent no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Exos Agent dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Exos Agent",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Exos Agent en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Exos Agent sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Exos Agent.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Exos Agent",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Exos Agent.",
