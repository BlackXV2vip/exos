export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.exos-agent.tagline": "Modèles optimisés et fiables",
  "dialog.provider.exosAgentGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "Visitez ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Exos Agent.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans exos-agent.json",
  ...
  "dialog.server.description": "Changez le serveur Exos Agent auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingExosAgent": "Vérification d'Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Vérification d'Exos Agent dans {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Mise à jour d'Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Mise à jour d'Exos Agent dans {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Mettez à jour Exos Agent dans {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Mettre à jour Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent est prêt dans {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent est prêt.",
  "wsl.onboarding.installExosAgentIn": "Installez Exos Agent dans {{distro}}.",
  "wsl.onboarding.installExosAgent": "Installer Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Exos Agent puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Exos Agent.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Exos Agent ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Exos Agent",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (exos-agent.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Exos Agent ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Exos Agent inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Exos Agent dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Exos Agent",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Exos Agent sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Exos Agent suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Exos Agent.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Exos Agent",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Exos Agent.",
