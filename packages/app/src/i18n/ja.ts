export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.exos-agent.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.exosAgentGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Exos Agentが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Exos Agentで{{provider}}モデルを使用します。",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.exosAgentZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.exosAgentZen.visit.prefix": " ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してExos Agentで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Exos Agentで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "exos-agent.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するExos Agentサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingExosAgent": "Exos Agentを確認中...",
  "wsl.onboarding.checkingExosAgentIn": "{{distro}}内のExos Agentを確認中...",
  "wsl.onboarding.updatingExosAgent": "Exos Agentを更新中...",
  "wsl.onboarding.updatingExosAgentIn": "{{distro}}内のExos Agentを更新中...",
  "wsl.onboarding.updateExosAgentIn": "{{distro}}内のExos Agentを更新してください。",
  "wsl.onboarding.updateExosAgent": "Exos Agentを更新",
  "wsl.onboarding.exosAgentReadyIn": "{{distro}}内のExos Agentの準備ができました。",
  "wsl.onboarding.exosAgentReady": "Exos Agentの準備ができました。",
  "wsl.onboarding.installExosAgentIn": "{{distro}}にExos Agentをインストールしてください。",
  "wsl.onboarding.installExosAgent": "Exos Agentをインストール",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agentがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Exos AgentでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Exos Agentをもう一度開いてください。",
  ...
  "toast.update.description": "Exos Agentの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをExos Agentチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (exos-agent.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: Exos AgentはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Exos Agentには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でExos Agentサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Exos Agentの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのExos Agentの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Exos Agentがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Exos Agentのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Exos Agent の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Exos Agent は最新バージョンです。",
