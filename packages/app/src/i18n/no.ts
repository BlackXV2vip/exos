...
export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.exos-agent.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.exosAgentGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "Besøk ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Exos Agent.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i exos-agent.json",
  ...
  "dialog.server.description": "Bytt hvilken Exos Agent-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Exos Agent ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Exos Agent-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (exos-agent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Exos Agent ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Exos Agent-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Exos Agent",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Exos Agent ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Exos Agent skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Exos Agent er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Exos Agent starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Exos Agent.",
  ...
  "wsl.onboarding.checkingExosAgent": "Sjekker Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Sjekker Exos Agent i {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Oppdaterer Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Oppdaterer Exos Agent i {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Oppdater Exos Agent i {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Oppdater Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent er klar i {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent er klar.",
  "wsl.onboarding.installExosAgentIn": "Installer Exos Agent i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Exos Agent kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Exos Agent på nytt.",
