export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.exos-agent.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.exosAgentGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "Odwiedź ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Exos Agent.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w exos-agent.json",
  ...
  "dialog.server.description": "Przełącz serwer Exos Agent, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingExosAgent": "Sprawdzanie Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Sprawdzanie Exos Agent w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Aktualizowanie Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Aktualizowanie Exos Agent w dystrybucji {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Zaktualizuj Exos Agent w dystrybucji {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Zaktualizuj Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent jest gotowy.",
  "wsl.onboarding.installExosAgentIn": "Zainstaluj Exos Agent w dystrybucji {{distro}}.",
  "wsl.onboarding.installExosAgent": "Zainstaluj Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Exos Agent będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Exos Agent.",
  ...
  "toast.update.description": "Nowa wersja Exos Agent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Exos Agent",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (exos-agent.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Exos Agent nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Exos Agent zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Exos Agent wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Exos Agent",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Exos Agent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Exos Agent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Exos Agent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Exos Agent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Exos Agent.",
