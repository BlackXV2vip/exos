export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.exos-agent.tagline": "Надежные оптимизированные модели",
  "dialog.provider.exosAgentGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "Посетите ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Exos Agent.",
  ...
  "dialog.plugins.empty": "Плагины настроены в exos-agent.json",
  ...
  "dialog.server.description": "Переключите сервер Exos Agent к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingExosAgent": "Проверка Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Проверка Exos Agent в {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Обновление Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Обновление Exos Agent в {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Обновите Exos Agent в {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Обновить Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent в {{distro}} готов к работе.",
  "wsl.onboarding.exosAgentReady": "Exos Agent готов к работе.",
  "wsl.onboarding.installExosAgentIn": "Установите Exos Agent в {{distro}}.",
  "wsl.onboarding.installExosAgent": "Установить Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Exos Agent требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Exos Agent.",
  ...
  "toast.update.description": "Новая версия Exos Agent ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Exos Agent",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (exos-agent.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Exos Agent пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Exos Agent внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Exos Agent",
  ...
  "settings.general.row.appearance.description": "Настройте как Exos Agent выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Exos Agent системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Exos Agent.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Exos Agent",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Exos Agent.",
