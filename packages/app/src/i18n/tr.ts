...
export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.exos-agent.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.exosAgentGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Exos Agent tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Exos Agent'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Exos Agent'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Exos Agent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler exos-agent.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Exos Agent sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingExosAgent": "Exos Agent kontrol ediliyor...",
  "wsl.onboarding.checkingExosAgentIn": "{{distro}} içinde Exos Agent kontrol ediliyor...",
  "wsl.onboarding.updatingExosAgent": "Exos Agent güncelleniyor...",
  "wsl.onboarding.updatingExosAgentIn": "{{distro}} içinde Exos Agent güncelleniyor...",
  "wsl.onboarding.updateExosAgentIn": "{{distro}} içindeki Exos Agent'u güncelleyin.",
  "wsl.onboarding.updateExosAgent": "Exos Agent'u güncelle",
  "wsl.onboarding.exosAgentReadyIn": "{{distro}} içinde Exos Agent hazır.",
  "wsl.onboarding.exosAgentReady": "Exos Agent hazır.",
  "wsl.onboarding.installExosAgentIn": "Exos Agent'u {{distro}} içine kurun.",
  "wsl.onboarding.installExosAgent": "Exos Agent'u kur",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Exos Agent'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Exos Agent'u tekrar açın.",
  ...
  "toast.update.description": "Exos Agent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Exos Agent ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (exos-agent.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Exos Agent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Exos Agent Masaüstü",
  ...
  "settings.desktop.wsl.description": "Exos Agent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Exos Agent'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Exos Agent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Exos Agent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Exos Agent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Exos Agent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Exos Agent'un en son sürümünü kullanıyorsunuz.",
