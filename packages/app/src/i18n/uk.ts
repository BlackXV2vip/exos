export const dict = {
  ...
  "dialog.provider.exos-agent.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.exos-agent.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.exosAgentGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Exos Agent",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Exos Agent.",
  ...
  "provider.connect.exosAgentZen.line1":
    "Exos Agent Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.exosAgentZen.visit.prefix": "Відвідайте ",
  "provider.connect.exosAgentZen.visit.link": "exos-agent.ai/zen",
  "provider.connect.exosAgentZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Exos Agent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Exos Agent.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в exos-agent.json",
  ...
  "dialog.server.description": "Перемкніть сервер Exos Agent, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingExosAgent": "Перевірка Exos Agent...",
  "wsl.onboarding.checkingExosAgentIn": "Перевірка Exos Agent у {{distro}}...",
  "wsl.onboarding.updatingExosAgent": "Оновлення Exos Agent...",
  "wsl.onboarding.updatingExosAgentIn": "Оновлення Exos Agent у {{distro}}...",
  "wsl.onboarding.updateExosAgentIn": "Оновіть Exos Agent у {{distro}}.",
  "wsl.onboarding.updateExosAgent": "Оновити Exos Agent",
  "wsl.onboarding.exosAgentReadyIn": "Exos Agent готовий до роботи у {{distro}}.",
  "wsl.onboarding.exosAgentReady": "Exos Agent готовий до роботи.",
  "wsl.onboarding.installExosAgentIn": "Встановіть Exos Agent у {{distro}}.",
  "wsl.onboarding.installExosAgent": "Встановити Exos Agent",
  ...
  "wsl.onboarding.distroStatus.exosAgentMissing": "Exos Agent не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Exos Agent потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Exos Agent не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Exos Agent.",
  ...
  "toast.update.description": "Нова версія Exos Agent ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Exos Agent",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (exos-agent.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Exos Agent ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Exos Agent містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Exos Agent всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Exos Agent",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Exos Agent на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Exos Agent використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Exos Agent.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Exos Agent",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Exos Agent.",
