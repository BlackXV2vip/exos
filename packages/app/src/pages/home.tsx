...
import { Logo } from "@exos-agent-ai/ui/logo"
import { Spinner } from "@exos-agent-ai/ui/spinner"
import { ScrollView } from "@exos-agent-ai/ui/scroll-view"
import { ProjectAvatar } from "@exos-agent-ai/ui/v2/project-avatar-v2"
...
import { base64Encode } from "@exos-agent-ai/core/util/encode"
...
import { Binary } from "@exos-agent-ai/core/util/binary"
import { ServerRowMenu } from "@/components/server/server-row-menu"
import { ServerHealthIndicator } from "@/components/server/server-row"
import { type ServerHealth } from "@/utils/server-health"
import { Persist, persisted } from "@/utils/persist"
import { useMarked } from "@exos-agent-ai/ui/context/marked"
import { preloadMarkdown } from "@exos-agent-ai/session-ui/markdown-cache"
      ...
      >
        <div class="mx-auto grid min-h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
          <HomeProjectColumn
            ...
            openHelp={() => platform.openLink("https://exos-agent.ai/desktop-feedback")}
            language={language}
            onWheel={(event) => {
