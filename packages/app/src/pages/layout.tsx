...
import { Session } from "@exos-agent-ai/sdk/v2/client"
...
import { toaster } from "@exos-agent-ai/ui/toast"
...
import { retry } from "@exos-agent-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@exos-agent-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://exos-agent.ai/desktop-feedback")}
      renderPanel={() =>
