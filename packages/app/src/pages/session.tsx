import type { FilePart, Project, UserMessage, VcsFileDiff } from "@exos-agent-ai/sdk/v2"
import { getFilename } from "@exos-agent-ai/core/util/path"
...
import type { SessionReviewLineComment } from "@exos-agent-ai/session-ui/session-review"
import { ResizeHandle } from "@exos-agent-ai/ui/resize-handle"
import { Select } from "@exos-agent-ai/ui/select"
import { SelectV2 } from "@exos-agent-ai/ui/v2/select-v2"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner } from "@exos-agent-ai/ui/scroll-view"
import { Tabs } from "@exos-agent-ai/ui/tabs"
import { ButtonV2 } from "@exos-agent-ai/ui/v2/button-v2"
import { createAutoScroll } from "@exos-agent-ai/ui/hooks"
import { previewSelectedLines } from "@exos-agent-ai/session-ui/pierre/selection-bridge"
import { Button } from "@exos-agent-ai/ui/button"
import { showToast } from "@/utils/toast"
import { base64Encode, checksum } from "@exos-agent-ai/core/util/encode"
...
import { SessionReviewEmptyChangesV2 } from "@exos-agent-ai/session-ui/v2/session-review-empty-changes-v2"
import { SessionReviewEmptyNoGitV2 } from "@exos-agent-ai/session-ui/v2/session-review-empty-no-git-v2"
import { SessionReviewV2SidebarToggle } from "@exos-agent-ai/session-ui/v2/session-review-v2"
