...
import type { FileSearchHandle } from "@exos-agent-ai/session-ui/file"
import { useFileComponent } from "@exos-agent-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@exos-agent-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@exos-agent-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@exos-agent-ai/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@exos-agent-ai/core/util/encode"
import { normalize, text } from "@exos-agent-ai/session-ui/session-diff"
import { DropdownMenu } from "@exos-agent-ai/ui/dropdown-menu"
import { IconButton } from "@exos-agent-ai/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@exos-agent-ai/ui/v2/line-comment-v2"
