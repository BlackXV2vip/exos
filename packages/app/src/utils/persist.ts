...
const GLOBAL_STORAGE = "exos-agent.global.dat"
const WINDOW_STORAGE = "exos-agent.window"
const LOCAL_PREFIX = "exos-agent."
...
function workspaceStorage(dir: string) {
  ...
  return `exos-agent.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `exos-agent.draft.${head}.${sum}.dat`
}
