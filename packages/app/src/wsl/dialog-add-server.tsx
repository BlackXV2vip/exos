...
import { showToast } from "@exos-agent-ai/ui/toast"
import { ButtonV2 } from "@exos-agent-ai/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@exos-agent-ai/ui/v2/dialog-v2"
import { DividerV2 } from "@exos-agent-ai/ui/v2/divider-v2"
import { LoaderV2 } from "@exos-agent-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@exos-agent-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-exos-agent") {
      await run(() => api.installExosAgent(distro))
      return
    }
