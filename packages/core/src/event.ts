...
import type { Data, Definition, Payload } from "@exos-agent-ai/schema/event"
...
import { Durable } from "@exos-agent-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@exos-agent-ai/schema/event").ID
export type { Data, Definition, Payload } from "@exos-agent-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/Event") {}
