...
import { Entry, FileSystem, FindInput, Match } from "@exos-agent-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@exos-agent-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/v2/FileSystem") {}
