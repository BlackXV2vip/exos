...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.EXOS_AGENT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
