...
export { Effect, Rule, Ruleset } from "@exos-agent-ai/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/v2/Permission") {}
