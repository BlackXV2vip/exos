...
import { PermissionSaved } from "@exos-agent-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/v2/PermissionSaved") {}
