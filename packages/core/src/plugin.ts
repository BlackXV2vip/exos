...
import type { Plugin as PluginRuntime } from "@exos-agent-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/v2/Plugin") {}
