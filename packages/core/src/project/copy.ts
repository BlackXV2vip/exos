...
import { Event } from "@exos-agent-ai/schema/project-directories"
import { ProjectCopy } from "@exos-agent-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/ProjectCopy") {}
