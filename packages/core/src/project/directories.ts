...
import type { EffectDrizzleSqlite } from "@exos-agent-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/ProjectDirectories") {}
