...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@exos-agent-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/v2/ToolRegistry") {}
