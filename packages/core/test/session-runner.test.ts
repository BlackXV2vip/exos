...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@exos-agent-ai/llm"
import * as OpenAIChat from "@exos-agent-ai/llm/protocols/openai-chat"
import { Database } from "@exos-agent-ai/core/database/database"
import { makeLocationNode } from "@exos-agent-ai/core/effect/app-node"
...
import { PermissionV2 } from "@exos-agent-ai/core/permission"
import { EventTable } from "@exos-agent-ai/core/event/sql"
import { Project } from "@exos-agent-ai/core/project"
import { ProjectTable } from "@exos-agent-ai/core/project/sql"
import { QuestionV2 } from "@exos-agent-ai/core/question"
import { AbsolutePath } from "@exos-agent-ai/core/schema"
import { SessionV2 } from "@exos-agent-ai/core/session"
import { Snapshot } from "@exos-agent-ai/core/snapshot"
import { ContextSnapshotDecodeError } from "@exos-agent-ai/core/session/error"
import { SessionEvent } from "@exos-agent-ai/core/session/event"
import { SessionInput } from "@exos-agent-ai/core/session/input"
import { SessionMessage } from "@exos-agent-ai/core/session/message"
import { Prompt } from "@exos-agent-ai/core/session/prompt"
import { SessionProjector } from "@exos-agent-ai/core/session/projector"
import { SessionExecution } from "@exos-agent-ai/core/session/execution"
import { SessionRunCoordinator } from "@exos-agent-ai/core/session/run-coordinator"
import { SessionRunner } from "@exos-agent-ai/core/session/runner"
import * as SessionRunnerLLM from "@exos-agent-ai/core/session/runner/llm"
import { SessionRunnerModel } from "@exos-agent-ai/core/session/runner/model"
import { ToolRegistry } from "@exos-agent-ai/core/tool/registry"
import { ApplicationTools } from "@exos-agent-ai/core/tool/application-tools"
import { AgentV2 } from "@exos-agent-ai/core/agent"
import { Config } from "@exos-agent-ai/core/config"
import { ConfigCompaction } from "@exos-agent-ai/core/config/compaction"
import { Tool } from "@exos-agent-ai/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@exos-agent-ai/core/session/sql"
import { SessionStore } from "@exos-agent-ai/core/session/store"
import { SystemContext } from "@exos-agent-ai/core/system-context"
import { SystemContextRegistry } from "@exos-agent-ai/core/system-context/registry"
import { SkillGuidance } from "@exos-agent-ai/core/skill/guidance"
import { ReferenceGuidance } from "@exos-agent-ai/core/reference/guidance"
