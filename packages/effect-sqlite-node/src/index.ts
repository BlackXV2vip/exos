...
export const TypeId: TypeId = "~@exos-agent-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@exos-agent-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@exos-agent-ai/effect-sqlite-node/NodeSqliteClient")
