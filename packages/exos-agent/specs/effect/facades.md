...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/exos-agent`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy exos-agent service removed
