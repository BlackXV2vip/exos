...
import { AccountStateTable, AccountTable } from "@exos-agent-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/AccountRepo") {}
