...
import { AbsolutePath, type DeepMutable } from "@exos-agent-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".exos-agent", "plans", "*.md")]: "allow",
