...
import { openEditor } from "@exos-agent-ai/tui/editor"
import { registerExosAgentKeymap } from "@exos-agent-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerExosAgentKeymap(keymap, renderer, input.tuiConfig)
