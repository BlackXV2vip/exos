...
import type { Event, GlobalEvent, ExosAgentClient } from "@exos-agent-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@exos-agent/RunStreamTransport") {}
