...
//
// The saved variant persists across sessions in ~/.local/state/exos-agent/model.json
...
class Service extends Context.Service<Service, VariantService>()("@exos-agent/RunVariant") {}
