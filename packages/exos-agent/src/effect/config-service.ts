 ...
 *   "@exos-agent/ServerAuthConfig",
 *   {
 *     password: Config.string("EXOS_AGENT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("EXOS_AGENT_SERVER_USERNAME").pipe(Config.withDefault("exos-agent")),
 *   },
 * ) {}
 *
