...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __EXOS_AGENT_PHOTON_WASM_PATH?: string }).__EXOS_AGENT_PHOTON_WASM_PATH =
