...
import { ChatCommand, TuiThreadCommand } from "./cli/cmd/tui"
...
const cli = yargs(args)
  ...
  .middleware(async (opts) => {
    ...
    process.env.AGENT = "1"
    process.env.EXOS_AGENT = "1"
    process.env.EXOS_AGENT_PID = String(process.pid)
  })
  .usage("")
