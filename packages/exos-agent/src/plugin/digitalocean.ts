import type { Hooks, PluginInput } from "@exos-agent-ai/plugin"
import type { Model } from "@exos-agent-ai/sdk/v2"
import { InstallationVersion } from "@exos-agent-ai/core/installation/version"
import { OauthCallbackPage } from "@exos-agent-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Exos Agent will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
