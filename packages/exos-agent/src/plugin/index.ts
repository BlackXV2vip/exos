...
} from "@exos-agent-ai/plugin"
import { Config } from "@/config/config"
import { createExosAgentClient } from "@exos-agent-ai/sdk"
import { ServerAuth } from "@/server/auth"
import { CodexAuthPlugin } from "./openai/codex"
import { Session } from "@/session/session"
import { NamedError } from "@exos-agent-ai/core/util/error"
import { CopilotAuthPlugin } from "./github-copilot/copilot"
import { gitlabAuthPlugin as GitlabAuthPlugin } from "@exos-agent/vendor-gitlab-auth"
import { PoeAuthPlugin } from "@exos-agent/vendor-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/Plugin") {}
