...
import { makeGlobalNode, Node } from "@exos-agent-ai/core/effect/app-node"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/InstanceStore") {}
