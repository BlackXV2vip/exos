...
import { ProjectDirectoryTable, ProjectTable } from "@exos-agent-ai/core/project/sql"
import { ProjectDirectories } from "@exos-agent-ai/core/project/directories"
...
import { which } from "@exos-agent-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.EXOS_AGENT_FAKE_VCS)
