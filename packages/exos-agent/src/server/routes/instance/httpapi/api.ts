...
import { makeApi } from "@exos-agent-ai/protocol/api"
import { LocationMiddleware } from "@exos-agent-ai/server/location"
import { SessionLocationMiddleware } from "@exos-agent-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("exos-agent-root")
...
export const InstanceHttpApi = HttpApi.make("exos-agent-instance")
...
export const ExosAgentHttpApi = HttpApi.make("exos-agent")
