import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@exos-agent-ai/llm"
...
// Move this extraction into @exos-agent-ai/llm when Copilot is handled by the native runtime.
