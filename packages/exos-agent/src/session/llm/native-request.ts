import type { JsonSchema, LLMRequest, ProviderMetadata } from "@exos-agent-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@exos-agent-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @exos-agent-ai/llm request objects from exos-agent's session/AI SDK-shaped data.
  return LLM.request({
