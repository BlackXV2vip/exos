...
import { Slug } from "@exos-agent-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@exos-agent-ai/llm"
...
import { locationServiceMapLayer } from "@exos-agent-ai/core/location-services"
...
import { PartTable, SessionTable } from "@exos-agent-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@exos-agent-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".exos-agent", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/Session") {}
