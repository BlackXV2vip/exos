...
import { SessionStatusEvent } from "@exos-agent-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/SessionStatus") {}
