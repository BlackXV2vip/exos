...
import type * as SDK from "@exos-agent-ai/sdk/v2"
...
import { SessionShareTable } from "@exos-agent-ai/core/share/sql"
...
const disabled = process.env["EXOS_AGENT_DISABLE_SHARE"] === "true" || process.env["EXOS_AGENT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@exos-agent/ShareNext") {}
