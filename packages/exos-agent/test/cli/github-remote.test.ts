...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/exos-agent.git")).toEqual({ owner: "sst", repo: "exos-agent" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/exos-agent")).toEqual({ owner: "sst", repo: "exos-agent" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/exos-agent.git")).toEqual({ owner: "sst", repo: "exos-agent" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/exos-agent")).toEqual({ owner: "sst", repo: "exos-agent" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/exos-agent.git")).toEqual({ owner: "sst", repo: "exos-agent" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/exos-agent")).toEqual({ owner: "sst", repo: "exos-agent" })
})
