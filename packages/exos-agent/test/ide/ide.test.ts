...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders EXOS_AGENT_CALLER", () => {
    process.env["EXOS_AGENT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode EXOS_AGENT_CALLER", () => {
    process.env["EXOS_AGENT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown EXOS_AGENT_CALLER", () => {
    process.env["EXOS_AGENT_CALLER"] = "unknown"
