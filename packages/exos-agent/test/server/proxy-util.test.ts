...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips exos-agent-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-exos-agent-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-exos-agent-directory")).toBeNull()
      expect(result.get("x-exos-agent-workspace")).toBeNull()
