...
> current private `@exos-agent-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@exos-agent-ai/ai`
...
- Secondary audience: Exos Agent and other durable agent runtimes
...
import { LLM } from "@exos-agent-ai/ai"
import { OpenAI } from "@exos-agent-ai/ai/providers/openai"
...
```ts
import { Message } from "@exos-agent-ai/ai"
...
import { LLM, Tool } from "@exos-agent-ai/ai"
...
Exos Agent and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@exos-agent-ai/ai/promise"
import { OpenAI } from "@exos-agent-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@exos-agent-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@exos-agent-ai/ai/provider"
...
@exos-agent-ai/ai/promise
  Promise/AsyncIterable LLM facade

@exos-agent-ai/ai/schema
  serializable domain schemas

@exos-agent-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@exos-agent-ai/ai/providers/openai
@exos-agent-ai/ai/providers/anthropic
@exos-agent-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@exos-agent-ai/llm`                      | `@exos-agent-ai/ai`                                           |
...
Exos Agent should migrate to `generateTurn` / `streamTurn`, preserving its durable
