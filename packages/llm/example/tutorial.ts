...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@exos-agent-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@exos-agent-ai/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-exos-agent-tutorial": "1" },
    query: { debug: "1" },
  },
})
