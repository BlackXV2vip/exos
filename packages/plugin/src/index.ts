import type {
  ...
  Part,
  Config as SDKConfig,
} from "@exos-agent-ai/sdk"
import type { Provider as ProviderV2, Model as ModelV2, Auth } from "@exos-agent-ai/sdk/v2"
...
export type PluginInput = {
  client: ReturnType<typeof createExosAgentClient>
  project: Project
  directory: string
  worktree: string
