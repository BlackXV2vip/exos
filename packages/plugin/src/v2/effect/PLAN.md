...
- Effect plugins import `@exos-agent-ai/plugin/v2/effect`, not `@exos-agent-ai/core`.
- Public domain values use generated `@exos-agent-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@exos-agent-ai/plugin/v2/effect`.
