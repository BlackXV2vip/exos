...
import defaultSoundPath from "@exos-agent-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@exos-agent-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@exos-agent-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@exos-agent-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@exos-agent-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@exos-agent-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "exos-agent"
const DEFAULT_PACK_ID = "exos-agent.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Exos Agent Default",
  builtin: true,
  sounds: {
