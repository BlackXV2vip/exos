...
import { registerExosAgentSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@exos-agent-ai/sdk/v2"
...
import { EXOS_AGENT_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useExosAgentKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.EXOS_AGENT_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
