...
import { useBindings, useExosAgentModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useExosAgentModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.EXOS_AGENT_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
