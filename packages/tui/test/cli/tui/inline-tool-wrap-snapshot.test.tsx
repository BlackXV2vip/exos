...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "EXOS_AGENT.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/exos-agent/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/exos-agent (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/exos-agent/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/exos-agent/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const EXOS_AGENT_DB|EXOS_AGENT_DB|EXOS_AGENT_DEV|Global\\.Path\\.data|data =" in packages/exos-agent/src (115 matches)',
  },
] as const
