...
const STORAGE_KEYS = {
  THEME_ID: "exos-agent-theme-id",
  COLOR_SCHEME: "exos-agent-color-scheme",
  THEME_CSS_LIGHT: "exos-agent-theme-css-light",
  THEME_CSS_DARK: "exos-agent-theme-css-dark",
} as const
