...
- Merge branch 'fix-gpt-5-6-responses-api' into 'main' ([7868119](https://gitlab.com/vglafirov/gitlab-ai-provider/commit/7868119))
- fix(models): route GPT-5.6 models through the Responses API ([eadbbe0](https://gitlab.com/vglafirov/gitlab-ai-provider/commit/eadbbe0))
- docs(readme): sync Available Model Mappings table with model-mappings.ts ([e16a28c](https://gitlab.com/vglafirov/gitlab-ai-provider/commit/e16a28c))

## 6.11.0 (2026-07-13)

- Merge branch 'feature-add-gpt-5-6' into 'main' ([283993c](https://gitlab.com/vglafirov/gitlab-ai-provider/commit/283993c))
- feat(models): add GPT-5.6 model mappings (Sol, Terra, Luna) ([2248cd0](https://gitlab.com/vglafirov/gitlab-ai-provider/commit/2248cd0))
...
- docs(skill): add MR, models.dev PR, and exos-agent bump steps ([3b4f366](https://gitlab.com/vglafirov/gitlab-ai-provider/commit/3b4f366))
...
- feat: add GPT-5.4, GPT-5.4 Mini, and GPT-5.4 Nano proxy model support ([7908719](https://gitlab.com/vglafirov/gitlab-ai-provider/commit/7908719))
...
- Use Exos Agent standard log directory for workflow debug logs ([28d1cc2](https://gitlab.com/gitlab-org/editor-extensions/gitlab-ai-provider/commit/28d1cc2))
