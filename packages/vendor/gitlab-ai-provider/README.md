...
- **🔐 Multiple Authentication**: Support for OAuth, Personal Access Tokens, and Exos Agent auth
...
```bash
npm install exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider
```
...
```typescript
import { createGitLab } from 'exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider';
...
Custom headers can be sent to GitLab's AI Gateway (Anthropic/OpenAI proxy) for traffic identification and routing. By default, the provider sends `User-Agent: exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/{version}`.
...
1. Default headers (`User-Agent: exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/{version}`)
...
```typescript
import { GitLabError } from 'exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider';
...
```
exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/
├── src/
...
Contributions are welcome! Please see our [Contributing Guide](https://gitlab.com/vglafirov/exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/-/blob/main/CONTRIBUTING.md) for detailed guidelines on:
...
- [GitLab Repository](https://gitlab.com/vglafirov/exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider)
- [npm Package](https://www.npmjs.com/package/exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider)
- [Issue Tracker](https://gitlab.com/vglafirov/exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/-/issues)
- [Contributing Guide](https://gitlab.com/vglafirov/exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/-/blob/main/CONTRIBUTING.md)
- [Changelog](https://gitlab.com/vglafirov/exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/-/blob/main/CHANGELOG.md)
- [Agent Guidelines](https://gitlab.com/vglafirov/exos-exos-exos-exos-exos-exos-exos-exos-exos-gitlab-ai-provider/-/blob/main/AGENTS.md)
