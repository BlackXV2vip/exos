...
[![npm version](https://img.shields.io/npm/v/exos-gitlab-auth.svg)](https://www.npmjs.com/package/exos-gitlab-auth)
...
git clone https://gitlab.com/vglafirov/exos-gitlab-auth.git
cd exos-gitlab-auth
...
```typescript
import gitlabAuthPlugin from 'exos-gitlab-auth';
...
1. **Check existing issues**: [GitLab Issues](https://gitlab.com/vglafirov/exos-gitlab-auth/-/issues)
...
Contributions are welcome! Please see our [Contributing Guide](https://gitlab.com/vglafirov/exos-gitlab-auth/-/blob/main/CONTRIBUTING.md) for detailed guidelines on:
...
- [GitLab Repository](https://gitlab.com/vglafirov/exos-gitlab-auth)
- [npm Package](https://www.npmjs.com/package/exos-gitlab-auth)
- [Issue Tracker](https://gitlab.com/vglafirov/exos-gitlab-auth/-/issues)
- [Contributing Guide](https://gitlab.com/vglafirov/exos-gitlab-auth/-/blob/main/CONTRIBUTING.md)
- [Changelog](https://gitlab.com/vglafirov/exos-gitlab-auth/-/blob/main/CHANGELOG.md)
- [Agent Guidelines](https://gitlab.com/vglafirov/exos-gitlab-auth/-/blob/main/AGENTS.md)
